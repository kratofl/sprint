...
export const tabsTriggerActiveClassName =
  "data-[state=active]:bg-[var(--panel-3)] data-[state=active]:text-[var(--orange)] data-[state=active]:border-[var(--orange)] group-data-[variant=line]/tabs-list:bg-transparent group-data-[variant=line]/tabs-list:data-[state=active]:bg-transparent group-data-[variant=line]/tabs-list:data-[state=active]:text-[var(--orange)] group-data-[variant=line]/tabs-list:data-[state=active]:border-b-2 group-data-[variant=line]/tabs-list:data-[state=active]:border-b-[var(--orange)] group-data-[variant=top]/tabs-list:data-[state=active]:bg-[var(--panel-4)] group-data-[variant=top]/tabs-list:data-[state=active]:text-[var(--orange)] group-data-[variant=top]/tabs-list:data-[state=active]:border-[var(--orange)] group-data-[variant=top]/tabs-list:data-[state=active]:shadow-none group-data-[variant=compact]/tabs-list:data-[state=active]:bg-[var(--panel-3)] group-data-[variant=compact]/tabs-list:data-[state=active]:text-[var(--orange)] group-data-[variant=compact]/tabs-list:data-[state=active]:border-[var(--orange)] group-data-[variant=vertical]/tabs-list:data-[state=active]:bg-[var(--panel-3)] group-data-[variant=vertical]/tabs-list:data-[state=active]:text-[var(--orange)] group-data-[variant=vertical]/tabs-list:data-[state=active]:border-[var(--orange)]"
