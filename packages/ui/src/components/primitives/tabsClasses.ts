...
export const tabsListVariantClassNames = {
  default:
    "surface-inline inline-flex w-fit items-center justify-center gap-1 rounded p-[3px] text-muted-foreground group-data-[orientation=horizontal]/tabs:h-8 group-data-[orientation=vertical]/tabs:h-fit group-data-[orientation=vertical]/tabs:flex-col",
  line:
  ...
  compact:
    "surface-inline inline-flex w-fit items-center justify-center gap-1 rounded p-[3px] text-muted-foreground",
  vertical:
