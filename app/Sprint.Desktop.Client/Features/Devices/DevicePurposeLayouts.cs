...
/// selecting them is enough to produce useful output. Rear-view video uses its own
/// desktop-capture frame source and therefore has no dash layout.
/// </summary>
        ...
        [
            new DashPage
            {
                ...
                [
                    new DashWidget
                    {
                        Id = "purpose-lap-times-racelogic",
                        Type = "racelogic_lap_timer",
                        Col = 0,
                        Row = 0,
                        ColSpan = 20,
                        RowSpan = 12,
