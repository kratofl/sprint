...
func (energyWidget) Definition(_ map[string]any) []Element {
	return []Element{
		...
		{Kind: ElemText, Text: "ENERGY", Font: FontLabel, FontScale: 0.14,
			X: 0.5, Y: 0.16, HAlign: HAlignCenter, VAlign: VAlignCenter, Color: ColorExpr{Ref: "muted"}},
		{Kind: ElemText, Binding: "energy.virtualEnergyPct", Format: "%.1f%%", Font: FontNumber, FontScale: 0.42,
			X: 0.5, Y: 0.5, HAlign: HAlignCenter, VAlign: VAlignCenter, Color: ColorExpr{Ref: "success"}},
		...
		{Kind: ElemText, Text: "REGEN", Font: FontLabel, FontScale: 0.12,
			X: 0.5, Y: 0.95, HAlign: HAlignCenter, VAlign: VAlignCenter, Color: ColorExpr{Ref: "muted"}},
	}
}
