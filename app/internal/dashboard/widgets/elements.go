...
// Text elements without Y are distributed vertically by the painter based on
// their count in the element list (auto-stacking). Set X/Y for exact
// widget-relative anchors. Use Grid for multi-column layouts.
type Text struct {
