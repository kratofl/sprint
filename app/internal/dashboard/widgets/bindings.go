...
const (
	...
	BindingTiresFLCoreTemp Binding = "tires.fl.coreTemp"
	BindingTiresFRCoreTemp Binding = "tires.fr.coreTemp"
	BindingTiresRLCoreTemp Binding = "tires.rl.coreTemp"
	BindingTiresRRCoreTemp Binding = "tires.rr.coreTemp"
)
